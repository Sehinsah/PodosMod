...
return ['<a:greenload:809341726593384458>', '<a:redload:809341762501869620>'].includes(reaction.emoji.name) && user.id === kullanıcı.id;
};
...
await mesaj.react("<a:greenload:809341726593384458>")
await mesaj.react("<a:redload:809341762501869620>")
...
if (reaction.emoji.name === '<a:greenload:809341726593384458>') {
