...
let no = "809341762501869620"; 
let yes = "809341726593384458";
let n = no;
let y = yes;

let embed = new Discord.MessageEmbed().setFooter("Podos#TAGLILAIM").setColor("RANDOM").setTimestamp();

if (!message.member.roles.cache.has("809285603749265429") && !message.member.hasPermission("ADMINISTRATOR")) return; //sahiprolu
